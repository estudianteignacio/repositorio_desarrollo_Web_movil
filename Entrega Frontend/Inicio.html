...
<head>
    ...
    <!-- Bootstrap 5.3 CSS PARA ICONOS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- FontAwesome Icons PARA ICONOS Y FUENTES -->
    ...
    <!-- JavaScript de Bootstrap 5 para Carrusel-->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    
    <!-- SETUP DE PALETA DE COLORES Y ESTILOS-->
    <style>
        ...
        /* CAJA DENTRO DE LA CATEGORIA */
        .cta-sketch-box {
            border: 4px dashed var(--pink-4);
            background-color: var(--yellow-1);
            border-radius: 18px;
            padding: 2.5rem 1.5rem;
            text-align: center;
            box-shadow: 6px 6px 0px var(--purple-2);
            transition: transform 0.2s, box-shadow 0.2s;
            cursor: pointer;
        }

        .cta-sketch-box:hover {
            transform: translate(-3px, -3px);
            box-shadow: 9px 9px 0px var(--purple-3);
        ...
        .product-card:hover {
            ...
            box-shadow: 0 10px 20px rgba(241, 96, 125, 0.15);
        }
        ...
        footer {
            background-color: var(--purple-5);
            color: white;
            border-top: 5px solid var(--yellow-4);
            margin-top: 3rem;
            padding: 2rem 0;
        }
        ...
        .footer-bottom {
            border-top: 1px solid rgba(255, 8, 8, 0.15);
            padding-top: 1rem;
            margin-top: 1rem;
        }
    </style>
                ...
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-md-end justify-content-between gap-2">
                        ...
                        <div class="d-flex align-items-center gap-2 ms-lg-2">
                            ...
                            <a href="login.php" class="top-icon-btn" title="Mensajes">
            ...
            <div class="row align-items-center gy-4">
                ...
                <div class="col-lg-5 col-md-6 col-12 text-center">
                    <div class="cake-wrapper">
                        <svg class="cake-svg" viewBox="0 0 600 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <img src="img/TortaInicio.png" alt="Torta" class="d-block w-100">
                        </svg>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12 ps-lg-4">
                    <ul class="category-list">
                        <li>Pasteles
                            <ul class="sub-category-list" style="font-family: 'montserrat'">
                                <li>tortas</li>
                                <li>tortas frías</li>
                                <li>etc.</li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-12 col-12">
                    <div class="cta-sketch-box" onclick="window.location.href='productos.php'">
                        <div class="cta-text">
                            haz tu pedido online hoy
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid segundoverde-">
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="img/Carrusel1.png" alt="Foto1" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                    <img src="img/Carrusel2.png" alt="Foto2" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                    <img src="img/Carrusel3.png" alt="Foto3" class="d-block w-100">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row gy-3 align-items-center">
                ...
                <div class="col-md-4 col-12 text-center">
                    <div><i style="color: var(--yellow-4);"></i><strong>Teléfono:</strong> +56 9 1234 5678</div>
                    <div><i style="color: var(--pink-3);"></i><strong>Local:</strong> Av. Avenida #123</div>
                </div>
